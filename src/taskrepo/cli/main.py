...
def llm_info(ctx):
    ...
    click.echo()
    click.echo("  # Find the next unblocked actionable task (JSON for coding agents)")
    click.echo("  tsk list --ready --json")
    click.echo()
    click.echo("  # Inspect tasks waiting on incomplete dependencies")
    click.echo("  tsk list --blocked")
    click.echo()
